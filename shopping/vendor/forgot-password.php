...
$query=mysql_query("SELECT * FROM vendor WHERE email='$email' and mobile='$contact'");
$num=mysql_fetch_array($query);
if($num>0)
{
mysql_query("update vendor set password='$password' WHERE email='$email' and mobile='$contact' ");
...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<span style="color:red;" >
		...
		<div class="form-group">
		 ...
		 <input type="text" name="mobile" class="form-control unicase-form-control text-input" id="mobile" required>
		</div>
<div class="form-group">
