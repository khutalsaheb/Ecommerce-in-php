...
{
$sql=mysql_query("SELECT password FROM  vendor where password='".md5($_POST['password'])."' && username='".$_SESSION['alogin']."'");
$num=mysql_fetch_array($sql);
if($num>0)
{
 $con=mysql_query("update vendor set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
