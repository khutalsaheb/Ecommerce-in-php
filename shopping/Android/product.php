<?php 
	...
	$subCategory = $_GET['subCategory'];			
		require_once 'config.php';	
			$sql = "SELECT DISTINCT * FROM category INNER JOIN subcategory on category.id=subcategory.categoryid INNER JOIN products ON subcategory.id=products.subCategory where products.subCategory='$subCategory'";
